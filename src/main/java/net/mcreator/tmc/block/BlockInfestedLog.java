...
public class BlockInfestedLog extends ElementsToomuchCommander.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("infestedlog"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tmc:infestedlog", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setUnlocalizedName("infestedlog");
