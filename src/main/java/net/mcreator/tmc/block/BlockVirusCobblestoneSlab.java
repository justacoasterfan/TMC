...
public class BlockVirusCobblestoneSlab extends ElementsToomuchCommander.ModElement {
	@GameRegistry.ObjectHolder("tmc:viruscobblestoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("tmc:viruscobblestoneslab_double")
	public static final Block block_slab_double = null;
	public BlockVirusCobblestoneSlab(ElementsToomuchCommander instance) {
		super(instance, 105);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("viruscobblestoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("viruscobblestoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("tmc:viruscobblestoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("viruscobblestoneslab");
